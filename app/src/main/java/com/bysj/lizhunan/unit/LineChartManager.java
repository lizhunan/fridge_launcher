...
public class LineChartManager {
    ...
    private static  LineChartManager INSTANCE;
     ...
     * @param color 曲线颜色
     */
    public LineChartManager(LineChart lineChart ,String name,int color){
     ...
     * @param colors 曲线颜色
     */
    public LineChartManager(LineChart lineChart, List<String> names, List<Integer> colors) {
        this.lineChart = lineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
    ...
    private void initLineChart(){
        ...
        legend.setTextColor(LauncherApplication.getContext().getResources().getColor(R.color.colorTealPrimaryDark)); //设置Legend 文本颜色
        //显示位置
    ...
    public void setHightLimitLine(float high, String name, int color) {
        if (name == null) {
            name = LauncherApplication.getContext().getString(R.string.hight_limit);
        }
